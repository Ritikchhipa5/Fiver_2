...
export default function Home() {
  const headData = {
    ...
    description:
      "Web3 Clubhouse. Buy an Addled Crocodile to explore more.",
  ...
  return (
    <>
      <Head>
        ...
        <script
          defer
          data-domain="addled.club"
          src="https://plausible.io/js/plausible.js"
        ></script>
      </Head>
      <>
        <div className="max-w-screen-2xl mx-auto relative px-4 md:px-8">
          <img alt="" src="/img/hero.png" className="hidden md:block" />
          <div className="md:hidden">
            <img alt="" src="/img/hero-logo.svg" />
            <img alt="" src="/img/hero-croc.svg" className="w-2/3 mx-auto" />
          </div>
        </div>
      </>
