...
export default function Navbar() {
  ...
  return (
    <div className={`z-50 fixed top-0 left-0 right-0 bg-white border-b border-black/20 py-2 transition-all ${scrollY >= 40 && "shadow-md"}`}>
      <div className="max-w-screen-2xl mx-auto flex justify-between items-center py-3 px-4 md:px-8 relative">
        ...
        <div className={`hidden lg:block transition-all duration-500 absolute transform ${router.asPath === "/" ? "left-8" : "left-1/2 -translate-x-1/2"}`}>
